      ...
      >
        {criminalActs.map((act, index) => (
          <SwiperSlide key={index}>
            <div className="flex rounded-lg shadow-lg overflow-hidden bg-gray-800">
              {/* Image Section */}
              <div className="flex-shrink-0 w-1/3 border-r border-gray-700 overflow-hidden">
                <img
                  ...
                  onError={(e) => { e.target.onerror = null; e.target.src = 'path/to/default-image.jpg'; }} // Replace with your default image path
                />
              </div>
